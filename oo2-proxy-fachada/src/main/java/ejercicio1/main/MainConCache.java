...
import ejercicio1.dominio.ProxyCacheClima;
import ejercicio1.dominio.Clima;
import ejercicio1.dominio.PorWebObtenerClima;

public class MainConCache {

	public static void main(String[] args) {

		Clima porWeb = new ProxyCacheClima(new PorWebObtenerClima("7d5536c9de5773ac0574b17c23335dc7"));
